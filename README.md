# Chess-Model---DSA-in-C

<!-- 
OBJECTIVE:
    Design and implement a command-line chess prototype in C that simulates an $8 \times 8$ board environment. The system must strictly enforce the movement and capture rules for two specific pieces: a White Queen and a Black Pawn, using a non-object-oriented approach.
